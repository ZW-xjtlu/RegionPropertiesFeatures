...
genomeDerivedFeatures <- function(x,
  ...
  cat("## --------------------------------------------------------------------------------------------------------------------------------------- ##\n", append=TRUE)
  cat("##                                               Extract properties over flanking regions of x                                             ##\n", append=TRUE)
  cat("## --------------------------------------------------------------------------------------------------------------------------------------- ##\n", append=TRUE)
  ...
  cat("## --------------------------------------------------------------------------------------------------------------------------------------- ##\n", append=TRUE)
  cat("##                                               Extract properties of exons                                                               ##\n", append=TRUE)                                              ##\n", append=TRUE)
  cat("## --------------------------------------------------------------------------------------------------------------------------------------- ##\n", append=TRUE)
  ...
  cat("## --------------------------------------------------------------------------------------------------------------------------------------- ##\n", append=TRUE)
  cat("##                                               Extract properties of introns                                                             ##\n", append=TRUE)                                              ##\n", append=TRUE)
  cat("## --------------------------------------------------------------------------------------------------------------------------------------- ##\n", append=TRUE)
  ...
  cat("## --------------------------------------------------------------------------------------------------------------------------------------- ##\n", append=TRUE)
  cat("##                                               Extract properties of exonic 5'UTR                                                        ##\n", append=TRUE)
  cat("## --------------------------------------------------------------------------------------------------------------------------------------- ##\n", append=TRUE)
  ...
  cat("## --------------------------------------------------------------------------------------------------------------------------------------- ##\n", append=TRUE)
  cat("##                                               Extract properties of full 5'UTR                                                          ##\n", append=TRUE)
  cat("## --------------------------------------------------------------------------------------------------------------------------------------- ##\n", append=TRUE)
  ...
  cat("## --------------------------------------------------------------------------------------------------------------------------------------- ##\n", append=TRUE)
  cat("##                                               Extract properties of exonic CDS                                                          ##\n", append=TRUE)
  cat("## --------------------------------------------------------------------------------------------------------------------------------------- ##\n", append=TRUE)
  ...
  cat("## --------------------------------------------------------------------------------------------------------------------------------------- ##\n", append=TRUE)
  cat("##                                               Extract properties of full CDS                                                            ##\n", append=TRUE)                                              ##\n", append=TRUE)
  cat("## --------------------------------------------------------------------------------------------------------------------------------------- ##\n", append=TRUE)
  ...
  cat("## --------------------------------------------------------------------------------------------------------------------------------------- ##\n", append=TRUE)
  cat("##                                               Extract properties of exonic 3'UTR                                                        ##\n", append=TRUE)
  cat("## --------------------------------------------------------------------------------------------------------------------------------------- ##\n", append=TRUE)
  ...
  cat("## --------------------------------------------------------------------------------------------------------------------------------------- ##\n", append=TRUE)
  cat("##                                               Extract properties of full 3'UTR                                                          ##\n", append=TRUE)
  cat("## --------------------------------------------------------------------------------------------------------------------------------------- ##\n", append=TRUE)
  ...
  cat("## --------------------------------------------------------------------------------------------------------------------------------------- ##\n", append=TRUE)
  cat("##                                               Extract properties of exonic transcripts                                                  ##\n", append=TRUE)
  cat("## --------------------------------------------------------------------------------------------------------------------------------------- ##\n", append=TRUE)
  ...
  cat("## --------------------------------------------------------------------------------------------------------------------------------------- ##\n", append=TRUE)
  cat("##                                               Extract properties of full transcripts                                                    ##\n", append=TRUE)                                              ##\n", append=TRUE)
  cat("## --------------------------------------------------------------------------------------------------------------------------------------- ##\n", append=TRUE)
  ...
  cat("## --------------------------------------------------------------------------------------------------------------------------------------- ##\n", append=TRUE)
  cat("##                                               Extract properties of intronic transcripts                                                ##\n", append=TRUE)
  cat("## --------------------------------------------------------------------------------------------------------------------------------------- ##\n", append=TRUE)
  ...
  cat("## --------------------------------------------------------------------------------------------------------------------------------------- ##\n", append=TRUE)
  cat("##                                               Extract properties of exonic genes                                                        ##\n", append=TRUE)                                              ##\n", append=TRUE)
  cat("## --------------------------------------------------------------------------------------------------------------------------------------- ##\n", append=TRUE)
  ...
  cat("## --------------------------------------------------------------------------------------------------------------------------------------- ##\n", append=TRUE)
  cat("##                                               Extract properties on full genes                                                       ##\n", append=TRUE)                                              ##\n", append=TRUE)
  cat("## --------------------------------------------------------------------------------------------------------------------------------------- ##\n", append=TRUE)
  ...
  cat("## --------------------------------------------------------------------------------------------------------------------------------------- ##\n", append=TRUE)
  cat("##                                               Extract properties of promoters                                                           ##\n", append=TRUE)                                              ##\n", append=TRUE)                                              ##\n", append=TRUE)
  cat("## --------------------------------------------------------------------------------------------------------------------------------------- ##\n", append=TRUE)
  ...
  cat("## --------------------------------------------------------------------------------------------------------------------------------------- ##\n", append=TRUE)
  cat("##                                               Extract properties of ", append=FALSE)
  cat(i, append=FALSE)
